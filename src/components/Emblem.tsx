...
export default function Emblem() {
    return (
        <div className="w-full md:w-[30vw] flex flex-col items-center justify-between gap-10 animate-appear-left">
            <Image fetchPriority="high" src={"https://res.cloudinary.com/dumndb22c/image/upload/v1724307286/hdo8oazfm1y4kmgra0g9.svg"} width={204} height={44} alt="Indian Emblem" className="w-[20vw]" />
